...
\centering
	\includegraphics[width=.8\textwidth]{figs/spheres.pdf}
    \newline
	\small{Intuition behind a persistence diagram (degree 2). Capable of capturing
	presence and significance of topological features (i.e., connected
...
Brittany Terese Fasy, Xiaozhou He, Zhihui Liu, Samuel Micka, David L. Millman, Binhai Zhu, "Approximate Nearest Neighbors in the Space of Persistence Diagrams", (In Progress: arXiv:1812.11257).
